            ...
            <div class="ecom-content">
              <div class="d-sm-flex align-items-center mb-4">
                <ul class="list-inline me-auto my-1">
                  <!--                   Agregar Producto
 --> <a href="create">
                    <button class="btn btn-link-secondary btn-prod-card">Add Product</button>
                  </a>
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex">
                            <div class="flex-shrink-0">
                              <a href="#" class="avtar avtar-s btn-link-secondary btn-prod-card" data-bs-toggle="offcanvas"
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item px-0">
          <div class="d-inline-flex align-items-center justify-content-between w-100">
            ...
            <h6 class="mb-0"><img src="<?= BASE_PATH ?>assets/images/application/img-prod-brand-1.png" alt="user-image"
                class="wid-40" /></h6>
          </div>
        </li>
      </ul>
              ...
              <div class="col-3">
                ...
                <div class="card mb-3" style="width: 18rem;">
                  ...
                  <div class="card-body">
                    ...
                    <a href="product.html" data-bs-toggle="modal" data-bs-target="#exampleModal"
